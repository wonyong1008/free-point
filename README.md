...
COMMENT ON COLUMN refresh_tokens.member_id IS 'members.id FK';
...
COMMENT ON COLUMN point_configs.id IS 'PK';
COMMENT ON COLUMN point_configs.config_key IS '설정 키 (MAX_ACCUMULATE_AMOUNT 등)';
COMMENT ON COLUMN point_configs.config_value IS '설정 값';
...
COMMENT ON COLUMN point_earnings.id IS 'PK';
COMMENT ON COLUMN point_earnings.point_key IS '적립 식별 키 (UUID)';
COMMENT ON COLUMN point_earnings.user_id IS '사용자 ID';
COMMENT ON COLUMN point_earnings.amount IS '적립 금액';
COMMENT ON COLUMN point_earnings.remaining_amount IS '남은 사용 가능 금액';
COMMENT ON COLUMN point_earnings.expiration_date IS '만료일';
COMMENT ON COLUMN point_earnings.is_manual IS '수기 지급 여부';
COMMENT ON COLUMN point_earnings.created_at IS '적립 시각';
...
COMMENT ON COLUMN point_usages.id IS 'PK';
COMMENT ON COLUMN point_usages.point_key IS '사용 식별 키 (UUID)';
COMMENT ON COLUMN point_usages.user_id IS '사용자 ID';
COMMENT ON COLUMN point_usages.order_number IS '주문 번호';
COMMENT ON COLUMN point_usages.amount IS '사용 금액';
COMMENT ON COLUMN point_usages.cancellable_amount IS '남은 취소 가능 금액';
COMMENT ON COLUMN point_usages.created_at IS '사용 시각';
...
COMMENT ON TABLE point_usage_details IS '어떤 적립이 얼마만큼 사용됐는지 매핑';
COMMENT ON COLUMN point_usage_details.id IS 'PK';
COMMENT ON COLUMN point_usage_details.point_usage_id IS 'point_usages.id FK';
COMMENT ON COLUMN point_usage_details.point_earning_id IS 'point_earnings.id FK';
COMMENT ON COLUMN point_usage_details.amount IS '해당 적립에서 사용된 금액';
...
COMMENT ON TABLE point_histories IS '전체 포인트 거래 이력 (ACCUMULATE, USE, USE_CANCEL, EXPIRE)';
COMMENT ON COLUMN point_histories.id IS 'PK';
COMMENT ON COLUMN point_histories.user_id IS '사용자 ID';
COMMENT ON COLUMN point_histories.type IS '이력 유형';
COMMENT ON COLUMN point_histories.point_key IS '관련 적립/사용 키';
COMMENT ON COLUMN point_histories.order_number IS '주문 번호(사용/취소 시)';
COMMENT ON COLUMN point_histories.amount IS '거래 금액';
COMMENT ON COLUMN point_histories.balance IS '거래 후 총 잔액';
COMMENT ON COLUMN point_histories.created_at IS '이력 생성 시각';
```
